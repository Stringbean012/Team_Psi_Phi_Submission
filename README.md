# Team_Psi_Phi_Submission
Submission to the Physics Techne Symposium 2026
...
In MATLAB
Run LoadData.m to load the data into Matlab workspace.
Run Plotting.m to plot the various graphs(spectrogram, IQ constellation etc.)
